            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('Judul_Buku') is-invalid @enderror" id="exampleInputTitle" placeholder="Judul Buku" name="Judul_Buku" value="{{old('Kode_Buku')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('Penulis') is-invalid @enderror" id="exampleInputWriter" placeholder="Penulis" name="Penulis">
